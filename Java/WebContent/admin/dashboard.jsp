...
<%
	...
	Hashtable<String, Integer> dsHopDongTheoThang = (Hashtable<String,Integer>)request.getAttribute("dsHopDongTheoThang");
%>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box bg-aqua">
                ...
                <span class="info-box-text">Phòng</span>
                  <span class="info-box-number"><%=soPhongDangThue%>/<%=soPhong%></span>

                  <div class="progress">
                    <div class="progress-bar" style="width: <%=KiemTra.tinhPhanTram(soPhongDangThue,soPhong)%>%"></div>
                  </div>
                  <span class="progress-description">
                    <%=KiemTra.tinhPhanTram(soPhongDangThue,soPhong)%>% Đang thuê
                  </span>
                </div>
                <!-- /.info-box-content -->
              </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box bg-green">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><%=soNam%>/<%=(soNu+soNam) %></span>

                  <div class="progress">
                    <div class="progress-bar" style="width: <%=KiemTra.tinhPhanTram(soNam,( soNam + soNu))%>%"></div>
                  </div>
                  <span class="progress-description">
                    <%=KiemTra.tinhPhanTram(soNam,( soNam + soNu))%>% Nam
                  </span>
                </div>
                <!-- /.info-box-content -->
              </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box bg-yellow">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><%=soNu%>/<%=( soNam + soNu)%></span>

                  <div class="progress">
                    <div class="progress-bar" style="width: <%=KiemTra.tinhPhanTram(soNu,( soNam + soNu))%>%"></div>
                  </div>
                  <span class="progress-description">
                    <%=KiemTra.tinhPhanTram(soNu,( soNam + soNu))%>% Nữ
                  </span>
                </div>
                <!-- /.info-box-content -->
              </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box bg-red">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><%=soNhanVien%></span>
