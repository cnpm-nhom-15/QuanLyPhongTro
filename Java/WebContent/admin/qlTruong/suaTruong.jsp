            ...
            <form class="form-horizontal" action="SuaTruongServlet" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="schoolID" class="col-sm-3 control-label">ID trường học:</label>

                  <div class="col-sm-8">
                    <input type="text" name="schoolID" class="form-control" id="schoolID"  value="1" readonly="readonly" >
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="schoolName" class="form-control" id="schoolName" placeholder="Tên trường" value="Đại học ahihi" required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="schoolAddress" class="form-control" id="schoolAddress" placeholder="Địa chỉ" value="Đà Nẵng" required>
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
